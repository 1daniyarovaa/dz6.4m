  ...
  return (
    <div className='Main'>
      <div className='Main_part1'>
        ...
        <h2 className='img_subtitle'>Lorem ipsumLorem ipsumLorem ipsumLorem 
        ipsumLorem ipLorem ipsumLorem ipLorem ipsumLorem ipsumLorem ipsumLorem 
        ipsumLorem ipLorem ipsumLorem ip</h2>
        ...
        <div className='Main_part4'>
          ...
          <img src={imgLine} alt=""  className='imgLine'/>
            ...
            <div className='text_blueFon'>
              ...
              <h2 className='lorem'>Lorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipLorem 
